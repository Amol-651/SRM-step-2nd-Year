// Q2_6PP.java
// Inheritance practice: Animal -> Mammal -> Dog
...
public class Q2_6PP {
    public static void main(String[] args) {
        ...
        System.out.println("\n=== Detailed Dog ===");
        Dog dog2 = new Dog("Dog", "House", 12, false,
                "Black", 58, "Labrador", true, 10, "Swimming");
    ...
    static class Animal {
        ...
        public String getAnimalInfo() {
            return species + " lives in " + habitat + ", lifespan: " + lifespan + " years, Wildlife: " + isWildlife;
        }
    }
