public class Q2_5PP {
    ...
    public Q2_5PP(String accNum, double initialBalance) {
    ...
    public void transfer(Q2_5PP target, double amount, int enteredPin) {
        if (!isLocked && validatePin(enteredPin) && balance - amount >= MIN_BALANCE) {
            balance -= amount;
    ...
    public static void main(String[] args) {
        Q2_5PP acc1 = new Q2_5PP("ACC100", 1000);
        Q2_5PP acc2 = new Q2_5PP("ACC200", 500);
